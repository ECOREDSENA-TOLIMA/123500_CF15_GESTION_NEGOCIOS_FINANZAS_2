...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .cajon.color-primario.p-4.mb-4(data-aos="zoom-in")
          .row.justify-content-around.align-items-center
            .col-3.col-sm-2.col-lg-2
              img(src="@/assets/curso/temas/tema1/4.svg")
            .col
    ...
    .row.justify-content-center.mb-4
      p(data-aos="fade-left") Para dar claridad a los tipos de variables vistas se puede revisar la siguiente tabla donde se ejemplifican otros elementos según sus características, por lo que le invitó a realizar su respectivo análisis:
          ...
          table
            ...
            tbody.text-center
              tr
                ...
                td 
              tr
                td Número de personas con el tipo de cabello.
                td 
                td x
              tr
                td Tipo de vivienda (casa, apartamento, predio rural).
                td x
                td 
              tr
                td Número de personas que prefiere cual tipo de vivienda. 
                td 
                td x
              tr
                td Tipos de color de ojos (azul, verde, gris, marrón). 
                td x
                td 
    ...
    .row.justify-content-center.mb-4
      .col-lg-10.col-12.mb-3
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-10.col-12.mb-3
            p(data-aos="fade-left") Para que, por medio de estos, las empresas puedan, mediante técnicas de simulación y modelos matemáticos, generar información que les permita identificar las tendencias cambiantes del sector en el que se mueven, así como descubrir otras oportunidades de negocio o pronosticar la demanda futura.
            p(data-aos="fade-left") Este tipo de herramientas informáticas ofrecen dos grandes ventajas a las empresas, ya que les ofrecen diversos servicios que les facilitan manejar la información con el fin de ser competitivas en todo momento, estas son:
        .row.justify-content-center.align-items-center
    ...
    .row.justify-content-center.mb-4
      p(data-aos="fade-left") En adición, se hace necesario revisar las funciones más comunes de los programas de análisis de datos, las cuales se muestran en el siguiente contenido:

    .row.justify-content-center.mb-4
      TabsC.color-acento-botones(data-aos="flip-up")
        .py-3.py-md-4(titulo="Visualizar datos")
          .row.p-4
            .col-md-6.mb-3
              figure
                img(src='@/assets/curso/temas/tema1/19.svg', alt='Texto que describa la imagen')
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Visualizar datos
              p Analizar datos sin procesar y presentar la información mediante tablas y gráficos interactivos.

        .py-3.py-md-4(titulo="Crear informes")
          .row.p-4
            .col-md-6.mb-3
              figure
            ...
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Crear informes
              p Analizar y organizar los datos en resúmenes informativos que pueden presentarse de forma impresa o exportarse a varios formatos.
        .py-3.py-md-4(titulo="Realizar análisis de regresión")
          .row.p-4
            .col-md-6.mb-3
              figure
                img(src='@/assets/curso/temas/tema1/21.svg', alt='Texto que describa la imagen')
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Realizar análisis de regresión
              p Establecer relaciones entre dos o más variables de interés para identificar el comportamiento de codependencia entre las variables dependientes y las independientes.  
        .py-3.py-md-4(titulo="Realizar análisis de múltiples variables")
          .row.p-4
            .col-md-6.mb-3
              figure
                img(src='@/assets/curso/temas/tema1/22.svg', alt='Texto que describa la imagen')
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Realizar análisis de múltiples variables
              p Observación y análisis simultáneo de múltiples diferentes variables dependientes con relación a otras variables.
        .py-3.py-md-4(titulo="Registrar series  temporales ")
          .row.p-4
            .col-md-6.mb-3
              figure
                img(src='@/assets/curso/temas/tema1/23.svg', alt='Texto que describa la imagen')
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Registrar series  temporales 
              p Captan secuencias en determinados momentos de un periodo definido y realizan predicciones con base en las tendencias anteriores.
        .py-3.py-md-4(titulo="Realizar simulaciones estadísticas")
          .row.p-4
            .col-md-6.mb-3
              figure
                img(src='@/assets/curso/temas/tema1/24.svg', alt='Texto que describa la imagen')
            .col-md-6.mb-4.mb-md-0.mb-3
              h4 Realizar simulaciones estadísticas
    ...
    datosSlyder: [
      {
        titulo: 'Discreta',
        texto:
          'Es el tipo de variable que ofrece resultados en valores que se encuentran separadas en escalas y no poseen valores entre ellas, de esta manera solo pueden adquirir un valor en números enteros, ejemplo: la cantidad de libros que compra una persona en un año.',
