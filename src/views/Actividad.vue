...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        ...
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            ...
            .col-auto
              a.boton.boton--b(:href="obtenerLink('/actividades/actividad/actividad.html')" target="_blank")
                span Realizar
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Elementos organizativos
        p.mb-4 Determinar los elementos categóricos que hacen parte de una organización, con el fin de identificar sus procesos institucionales.
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
